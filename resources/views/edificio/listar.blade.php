...
@section('contenido')
    ...
    <div class="flex flex-col items-center mt-10 mb-10">
        <div class="mb-5">
            <h1 class="text-2xl font-semibold">Gestión de Edificios</h1>
        </div>
        ...
        <table class="table-auto w-3/5 border border-gray-700 text-center">
            <thead>
                <tr class="border-b border-gray-800 bg-gray-700">
                    ...
                    <th class="py-2 text-white">Código Postal</th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="py-4 bg-gray-50">No existen edificios</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
